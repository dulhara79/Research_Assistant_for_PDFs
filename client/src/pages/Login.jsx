      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white/5">
        <div className="w-full max-w-md space-y-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6 mt-8">
            ...
            {error && <div className="p-3 rounded-lg bg-red-50/10 text-red-600 text-sm border border-red-200">{error}</div>}

            <Button type="submit" isLoading={loading} className="w-full bg-indigo-600 hover:bg-indigo-700 text-white">
